...
Desarrollado con node y dependencias generadas con npx create-react-app my-project-name y bajo el concepto "first offline PWA" (Testear instalador de la web en el dispositivo móvil y usar la herramienta de navegador "lighthouse para hacer prueba de performance").
